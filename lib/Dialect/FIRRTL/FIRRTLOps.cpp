...
flow::Flow firrtl::foldFlow(Value val, flow::Flow acc) {
  auto swap = [&acc]() -> flow::Flow {
    switch (acc) {
    case flow::Source:
      return flow::Sink;
    case flow::Sink:
